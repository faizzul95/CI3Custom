...
class Migration_create_users extends CI_Migration
{
	...
	public function up()
	{
		$this->dbforge->add_field([
			...
			'user_status' => ['type' => 'TINYINT', 'default' => '4', 'null' => TRUE, 'comment' => '0-Inactive, 1-Active, 2-Suspended, 3-Deleted, 4-Unverified'],
			...
			'change_password' => ['type' => 'TINYINT', 'default' => '0', 'null' => TRUE, 'comment' => '0-No, 1-Yes'],
