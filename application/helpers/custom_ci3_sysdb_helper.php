    ...
    function generateMigration($table, $filename = null)
    {
        ...
        try {
            ...
            foreach ($fields as $field) {
                ...
                if (isset($field->auto_increment)) $content .= ", 'auto_increment' => TRUE";
                if ($field->default !== null && !$field->auto_increment) $content .= ", 'default' => '" . $field->default . "'";
                $content .= ", 'null' => TRUE, 'comment' => ''],\n";
            }
            $content .= "\t\t]);\n\n";
